...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "SELECT upwd FROM users WHERE uid = :username";
        $query = $dbh->prepare($sql);
        $query->bindParam(':username', $username, PDO::PARAM_STR);
        $query->execute();
        $result = $query->fetch(PDO::FETCH_ASSOC);

        if ($result && password_verify($password, $result['upwd'])) {
            ...
            if ($newpassword === $confirmpassword) {
                ...
                $sqlUpdatePassword = "UPDATE users SET upwd = :newPassword WHERE uid = :username";
                $queryUpdatePassword = $dbh->prepare($sqlUpdatePassword);
                $queryUpdatePassword->bindParam(':newPassword', $newPasswordHash, PDO::PARAM_STR);
                $queryUpdatePassword->bindParam(':username', $username, PDO::PARAM_STR);
 ...
 <strong>OK!</strong><?php echo htmlentities($msg); ?>
    ...
    <div class="alert alert-danger left-icon-alert" role="alert">
                                    ...
                                    <input type="password" name="password" class="form-control" required="required" id="success">
                                                     ...
                                                     <div class="form-group has-success">
                                                        <label for="success" class="control-label">Nhập Lại Mật Khẩu Mới</label>
                                                        <div class="">
