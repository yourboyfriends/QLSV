...
{
$class=$_POST['mlcn'];
$subject=$_POST['tenhocphan']; 
$status=1;
$sql="INSERT INTO  tblsubjectcombination(ClassId,SubjectId,status) VALUES(:class,:subject,:status)";
$query = $dbh->prepare($sql);
$query->bindParam(':mlcn',$class,PDO::PARAM_STR);
$query->bindParam(':tenhocphan',$subject,PDO::PARAM_STR);
...
<?php $sql = "SELECT * from tbl_lophocphan";
$query = $dbh->prepare($sql);
$query->execute();
...
<div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
 <select name="tenhocphan" class="form-control" id="default" required="required">
