                                        ...
                                        <?php } ?>
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT tbl_sinhvien.msv,tbl_sinhvien.holot,tbl_sinhvien.ten,tbl_diemhocphan.mhp, tbl_diemhocphan.a,tbl_diemhocphan.b,tbl_diemhocphan.c from tbl_sinhvien
...
<tr>
 <td><?php echo htmlentities($cnt);?></td>
                                                            ...
                                                            <td><?php echo htmlentities($result->holot);?> <?php echo htmlentities($result->ten);?></td>
...
echo htmlentities('Active');
   ...
   echo htmlentities('Blocked'); 
                                                                ...
                                                                ?></td>
<td>
<a href="edit-student.php?stid=<?php echo htmlentities($result->StudentId);?>" style="color: #5cb85c;"><i class="fa fa-edit" title="Edit Record"></i> sửa </a> 
